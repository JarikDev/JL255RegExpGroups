...
public class Main {
    public static void main(String[] args) {
        // Pattern p= Pattern.compile("Set(?:Value)?"); //() backreferences //?: dont use backreferences
...
//        System.out.println("EditPad Lite".replaceAll("EditPad (Lite|Pro)", "\\I1 version")); // each letter uppercase
        ...
        Pattern p4= Pattern.compile("([a-c])x\\1x\\1"); //[a-c]x[a-c]x[a-c]
        ...
        while (m42.find()){
            System.out.println(m42.start()+" "+m42.group()+" ");
        }
        System.out.println("");
